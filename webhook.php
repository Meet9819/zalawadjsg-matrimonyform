...
$mac_calculated = hash_hmac("sha1", implode("|", $data), "1af159d566c64413ba6e3bfa082fead8");

//$mac_calculated = hash_hmac("sha1", implode("|", $data), "3736050c2fde40e099e214646e2994c7");
